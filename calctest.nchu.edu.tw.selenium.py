    ...
    def grade_one_exam(exam_name):
        for exam_tr in find_non_empty_elements_by_tag_name():
            ...
            if not any(
                    ...
                    for link_text in exam_tr.find_elements(By.CLASS_NAME,'semi-typography-link-text')):
                continue
            ...
            while grade_one_student():
                pass
            for navigation in driver.find_elements(By.CLASS_NAME,"semi-navigation-item-text"):
